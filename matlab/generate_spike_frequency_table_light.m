...
pre_spike_table.time = [recording_start_time + seconds(bin_size):seconds(bin_size):final_spike_time]';
writetable(pre_spike_table, ['light_' output_path]);
...
writetable(light_spike_table, ['pre_' output_path]);
