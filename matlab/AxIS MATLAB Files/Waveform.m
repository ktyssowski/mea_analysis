classdef Waveform
    ...
    methods
        ...
        function voltageData = GetVoltageVector(this)
            ...
            %voltageData = fData * diag(fVoltageScale); % This is how axion wrote the function. This is very inefficient
            voltageData = bsxfun(@times, fData, fVoltageScale); % This is equivalent but vastly more efficient
        end
